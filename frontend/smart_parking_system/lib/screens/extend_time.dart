...
class _ExtendTimeState extends State<ExtendTime> {
  ...
  void initState() {
    ...
    _startTime = DateTime(currentDate.year, currentDate.month, currentDate.day, 18, 0);

    // Set the end time to 11:00 PM on the current date
    _endTime = DateTime(currentDate.year, currentDate.month, currentDate.day, 23, 0);
  }
        ...
        child: Column(
          children: [
            ExtendTimePage(
              ...
              buttonsEnabled: _buttonsEnabled, // Pass the state variable to the child widget
            ),
            SizedBox(height: 16),
            GestureDetector(
              onTap: _resetPage,
...
class ExtendTimePage extends StatefulWidget {
  ...
  final bool buttonsEnabled; // Receive the state variable indicating whether buttons should be enabled
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: widget.buttonsEnabled
                    ...
                    widget.onExtendTime(widget.endTime.add(extensionDuration), _price);
                  }
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.pushNamed(context, '/payment_page', arguments: {'price':_price});
                },
                style: ElevatedButton.styleFrom(
                  primary: Colors.blue,
                  minimumSize: Size(double.infinity, 50),
